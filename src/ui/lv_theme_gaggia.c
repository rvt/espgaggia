...
#define TRANSITION_TIME         0/*((theme.flags & LV_THEME_GAGGIA_FLAG_NO_TRANSITION) ? 0 : 150)*/
#define BORDER_WIDTH            LV_DPX(2)
#define OUTLINE_WIDTH           ((theme.flags & LV_THEME_GAGGIA_FLAG_NO_FOCUS) ? 0 : LV_DPX(2))
#define IS_LIGHT (theme.flags & LV_THEME_GAGGIA_FLAG_LIGHT)
...
static void basic_init(void) {
    ...
    lv_style_set_bg_opa(&styles.bg, LV_STATE_DEFAULT, /*LV_OPA_COVER*/LV_OPA_80);
    ...
    if ((theme.flags & LV_THEME_GAGGIA_FLAG_NO_FOCUS) == 0)lv_style_set_border_color(&styles.bg, LV_STATE_FOCUSED,
                theme.color_primary);

    lv_style_set_border_color(&styles.bg, LV_STATE_EDITED, theme.color_secondary);
    lv_style_set_border_width(&styles.bg, LV_STATE_DEFAULT, /*BORDER_WIDTH*/0);
    ...
    lv_style_set_radius(&styles.btn, LV_STATE_DEFAULT, 3);
    ...
    lv_style_set_border_opa(&styles.btn, /*LV_STATE_CHECKED*/LV_STATE_DEFAULT, LV_OPA_TRANSP);
    ...
    lv_style_set_outline_opa(&styles.btn, LV_STATE_FOCUSED, /*LV_OPA_50*/LV_OPA_TRANSP);
    ...
    lv_style_int_t pad_small_value = lv_disp_get_size_category(NULL) <= LV_DISP_MEDIUM_LIMIT ? LV_DPX(6) : LV_DPX(12);
...
static void tabview_win_shared_init(void) {
    ...
    lv_style_set_bg_opa(&styles.tabview_page_scrl, /*LV_STATE_PRESSED*/LV_STATE_DEFAULT, LV_OPA_TRANSP);
