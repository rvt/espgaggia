...
void ili9341_init(void) {
    lcd_init_cmd_t ili_init_cmds[] = {
        ...
        {0xF2, {0x08}, 1},
        {0x26, {0x01}, 1},
        // Gamma from https://momosan.cc/usr/uploads/2018/06/803612085.pdf
        {0xE0, {0x0F, 0x3a, 0x36, 0x0b, 0x0d, 0x06, 0x4c, 0X91, 0x31, 0x08, 0x10, 0x04, 0x11, 0x0c, 0x00}, 15},
        {0XE1, {0x00, 0x06, 0x0a, 0x05, 0x12, 0x09, 0x2c, 0x92, 0x3f, 0x08, 0x0e, 0x0b, 0x2e, 0x33, 0x0F}, 15},

        // Gamma from https://www.avrfreaks.net/forum/ili9341      Seems best so far
